...
// c1.onChange = function(){     //event called when position of counter 6-1 changes
//     console.log("pos changed to " + this.pos);
// }

var c2 = new Counter(acw_example6_2);
// plus2.onclick = function(){ c2.next(); };
// minus2.onclick = function(){ c2.previous();};

var c3 = new Counter(acw_example6_3);
// plus3.onclick = function(){ c3.next(); };
// minus3.onclick = function(){ c3.previous(); };

var c4 = new Counter(acw_example6_4);
